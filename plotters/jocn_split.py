...
def plot_compare_delay_bar_B():
    ...
    ax1.bar(x_high_2400, high_go, color='white',edgecolor='red', label="None/High",linewidth=4, width=width,hatch='//')
    ax1.bar(x_med_2400, med_go,  color='white',edgecolor='green', label="None/Med",linewidth=4, width=width,hatch='//')
    ax1.bar(x_low_2400, low_go,  color='white',edgecolor='blue', label="None/Low",linewidth=4, width=width,hatch='//')
